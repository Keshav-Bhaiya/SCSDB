...
const TvDetails = ()=>{
  const{pathname} = useLocation();
    ...
    return info ?(
      <div style={{
      ...
      }} className="relative w-full h-[245vh] px-[10%] ">
        ...
        {/* Part1 */}
          ...
          <h1 className="text-xl font mt-4 mb-2 ">tv Translations</h1>
          ...
          <div className="w-[80%] flex flex-col gap-y-5 mt-10">
            ...
            <div className="w-[100%] flex overflow-y-hidden mb-5 p-5">
              {info.detail.seasons.length > 0 ? info.detail.seasons.map((s,i)=>(
                <div className="w-[14vw] mr-5">
            <img className="shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] h-[40vh] min-w-[13vw]  object-cover" 
