    ...
    <div className="flex flex-wrap w-full h-full px-[5%]">
      ...
      <Link to={`/${c.media_type || title}/details/${c.id}`} className="relative w-[25vh] mr-[5%] mb-[5%]" key={i}>
        ...
        src={c.poster_path || c.backdrop_path  || c.profile_path ?
          ...
          <h1 className="text-2xl text-zinc-300 mt-3 font-semibold">{c.name || 
        c.title || 
        c.original_name || 
        c.original_title
        }
        ...
        {c.vote_average &&(
          <div className="absolute right-[-10%] bottom-[30%]  text-white text-xl font-semibold w-[6vh] h-[6vh] flex justify-center rounded-full items-center bg-yellow-600">
